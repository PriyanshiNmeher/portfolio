            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <motion.div
                        ...
                        className="relative"
                    >
                        <div className="aspect-square rounded-2xl overflow-hidden bg-slate-800 border-2 border-white/10 relative group">
                         <Image
                src={image}
                alt="Profile Image"
                fill
                    ...
                    >
                        ...
                        <div className="grid grid-cols-2 gap-4 mt-8">
                            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                                ...
                                <p className="text-sm text-slate-400">Next.js, React, Node</p>
                            </div>
                            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                                <Database className="text-secondary mb-2" />
                                <h4 className="font-bold">Data Science</h4>
                                <p className="text-sm text-slate-400">Python, ML, Pandas</p>
                            </div>
                            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                                <Cpu className="text-accent mb-2" />
                                <h4 className="font-bold">Electronics</h4>
                                <p className="text-sm text-slate-400">IoT, Embedded Systems</p>
                            </div>
                        </div>
                    </motion.div>
                </div>
